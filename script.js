...
window.onload = () => {
  ...
  if (heroVideo) {
    heroVideo.play().catch(err => console.warn("Hero video autoplay failed."));
  }
...
const pressLinks = [
  ...
  { title: "MDLBEAST – Labels at XP Nite in Riyadh", url: "https://mdlbeast.com/xp-feed/music-industry/the-labels-collectives-taking-over-xp-nite-dec-7th-9th", source: "MDLBEAST" },
